...
for i, SNR in enumerate(SNR_list):
  ...
  for j, x in enumerate(x_list):
    ...
    # encorder
    model.add(layers.Conv2D(16, (5, 5), strides=2, padding='valid', input_shape=(32, 32, 3), name='Encoder_Conv2D_1'))
    model.add(layers.PReLU(name='Encoder_PReLU_1'))

    model.add(layers.Conv2D(32, (5, 5), strides=2, padding='valid', name='Encoder_Conv2D_2'))
    ...
    model.add(layers.Conv2DTranspose(3, (5, 5), strides=2, padding='valid',  activation='sigmoid', name='Decoder_TransConv2D_5'))
